...
document.querySelector(".start-game-button").addEventListener("click", StartGameTest)

function ResetHasPlayed() { for (let i = 0; i < StartingGrid.length; i++) { StartingGrid[i].hasPlayed = false } }